...
const createCoursesTable = async () => {
  const query = `
    CREATE TABLE IF NOT EXISTS courses (
      ...
      course_category INTEGER NOT NULL REFERENCES course_categories(category_id),
...
async function addCourse({
  ...
  const query = {
    text: `
      INSERT INTO courses
      (course_author, course_title, course_description, course_price, course_rate, course_length, course_category, course_image, course_objectives, course_requirements, course_tagline, trainer_id)
