...
const createCoursesTable = async () => {
  const query = `
    CREATE TABLE IF NOT EXISTS courses (
      ...
      catagory_id INTEGER NOT NULL REFERENCES course_catagories(catagory_id),
...
async function addCourse({
  ...
  const query = {
    text: `
      INSERT INTO courses
      (course_title, course_author, course_description, course_price, course_rate, course_length, course_catagory, course_image, course_objectives, course_requirements, course_tagline, trainer_id)
